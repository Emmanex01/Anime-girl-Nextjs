...
export function ProductDetailsContent({ product: selectedProduct }: ProductDetailsContentProps) {
  const { 
    ...
    removeFromWishlist, 
    isWishlisted,
    products // Pulling dynamic catalog from store instead of legacy data.ts file
  } = useShopStore();
  ...
  // Fix: Smart gallery resolver. Uses manual high-fi overrides if they exist, 
  // otherwise defaults to live Shopify images arrays seamlessly.
  const imagesList = useMemo(() => {
    if (GALLERY_IMAGES[selectedProduct.id]) {
      return GALLERY_IMAGES[selectedProduct.id];
    }
    if (selectedProduct.images && selectedProduct.images.length > 0) {
      return selectedProduct.images.map((img) => img.url);
    }
    return [selectedProduct.image];
  }, [selectedProduct.id, selectedProduct.images, selectedProduct.image]);
  ...
  // Related products logic - filter from same category or list others from dynamic list
    ...
    >
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 py-8 pb-32">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14">
          ...
          {/* COLUMN 1: Galleried Media System */}
          ...
          {/* COLUMN 2: Meta Control Panel & Specifications */}
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-4 py-1.5 border-y border-white/5">
                ...
                <a href="#reviews-anchor" className="text-[10px] font-black tracking-widest text-[#00f2ff] hover:underline uppercase italic flex items-center gap-1.5">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-black uppercase tracking-widest text-white/60">
                  VARIANT SIZE: <span className="text-[#00f2ff]">{selectedSize}</span>
                </span>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                {sizes.map((sz) => (
                  <button
                    ...
                    className={`py-3 rounded-sm text-[9px] font-black tracking-wider uppercase italic border transition-all cursor-pointer ${
                      selectedSize === sz
                        ? 'bg-[#00f2ff]/10 border-[#00f2ff] text-white shadow-[0_0_10px_rgba(0,242,255,0.15)]'
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-black uppercase tracking-widest text-white/60">
                  VARIANT SKIN: <span className="text-[#ff003c]">{selectedColor}</span>
                </span>
              ...
              <div className="space-y-2">
                {colors.map((col) => (
                  <button
                    ...
                    className={`w-full py-3.5 px-4 rounded-sm border flex items-center justify-between transition-all cursor-pointer ${
                      selectedColor === col
                        ? 'bg-[#ff003c]/10 border-[#ff003c] text-white shadow-[0_0_10px_rgba(255,0,60,0.1)]'
                        : 'bg-[#0a0c13] border-white/5 text-white/50 hover:border-white/10 hover:text-white'
                    }`}
                  >
            ...
            <div className="pt-6 border-t border-white/5 space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="flex items-center border border-white/10 bg-black/40 rounded-sm p-1">
                    <button
                      ...
                      className="w-8 h-8 rounded-sm hover:bg-white/5 flex items-center justify-center text-white/50 hover:text-white cursor-pointer"
                    >
                ...
                <div className="flex-1 flex flex-col gap-1.5 justify-end">
                  ...
                  <button
                    ...
                    className="w-full bg-[#ff003c] hover:bg-[#ff003c]/90 text-white font-black h-[42px] px-6 rounded-sm text-[11px] tracking-[0.2em] uppercase italic transition-all flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(255,0,60,0.3)] hover:shadow-[0_0_25px_rgba(255,0,60,0.5)] active:scale-[0.98] cursor-pointer"
                  >
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <button
                  ...
                  className={`h-[42px] rounded-sm text-[9.5px] uppercase font-black tracking-widest italic border flex items-center justify-center gap-2 transition-all cursor-pointer ${
                    wishlisted
                      ? 'border-[#ff003c] bg-[#ff003c]/10 text-[#ff003c] shadow-[0_0_10px_rgba(255,0,60,0.25)]'
                      : 'border-white/10 hover:border-white/20 text-white'
                  }`}
                >
                  <Heart className={`w-3.5 h-3.5 ${wishlisted ? 'fill-[#ff003c]' : ''}`} />
                ...
                <button
                  ...
                  className="h-[42px] rounded-sm text-[9.5px] uppercase font-black tracking-widest italic border border-[#00f2ff]/30 hover:bg-[#00f2ff]/5 text-[#00f2ff] flex items-center justify-center gap-2 transition-all shadow-[0_0_15px_rgba(0,242,255,0.05)] hover:shadow-[0_0_15px_rgba(0,242,255,0.2)] cursor-pointer"
                >
        ...
        <div className="mt-20 pt-12 border-t border-white/5 space-y-6">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg md:text-xl font-display font-black uppercase tracking-tight italic text-white">
              RELATED <span className="text-[#00f2ff]">RELEASES</span>
            </h3>
          </div>
            ...
            {relatedList.map((rel) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <h4 className="text-xs font-display font-black text-white group-hover:text-[#00f2ff] transition-colors uppercase tracking-tight truncate">
                    {rel.name}
                  </h4>
        ...
        <div id="reviews-anchor" className="mt-20 pt-12 border-t border-white/5 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14">
          ...
          {/* Sticky/Responsive interactive Write A Review Form Column */}
              ...
              {formSuccess ? (
                <div className="p-4 bg-emerald-400/10 border border-emerald-400/30 rounded-sm text-center space-y-3">
                   ...
                   <button
                     ...
                     className="text-[9px] uppercase tracking-widest text-white hover:text-neon-blue border border-white/5 hover:border-white/20 transition-all rounded-sm px-4 py-2 bg-white/5 cursor-pointer"
                   >
                     WRITE ANOTHER RECON
                   </button>
                </div>
                ...
                <form onSubmit={handlePostReview} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      {[1, 2, 3, 4, 5].map((star) => (
                        ...
                        >
                          <Star 
                            className={`w-6 h-6 ${star <= formRating ? 'fill-yellow-500 text-yellow-500' : 'text-neutral-700'}`} 
                          />
                        </button>
                      ))}
                    </div>
                  ...
                  <button
                    type="submit"
                    className="w-full h-11 bg-transparent border border-[#ff003c]/60 hover:bg-[#ff003c]/10 text-[#ff003c] font-black text-[10px] tracking-[0.2em] uppercase italic transition-all rounded-sm flex items-center justify-center gap-2 shadow-[0_0_15px_rgba(255,0,60,0.05)] hover:shadow-[0_0_15px_rgba(255,0,60,0.2)] cursor-pointer"
                  >
      ...
      {/* SECTION: Sticky Add-to-Cart Panel footer */}
      <AnimatePresence>
        {isStickyVisible && (
          <motion.div
            initial={{ y: 90 }}
          ...
          >
            <div className="flex items-center gap-4 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <div className="flex items-center gap-2 mt-0.5">
                  <span className="bg-[#00f2ff]/10 text-[#00f2ff] border border-[#00f2ff]/20 rounded-sm text-[8px] font-mono px-1.5 font-bold">
                    {selectedSize}
                  </span>
                  <span className="bg-[#ff003c]/10 text-[#ff003c] border border-[#ff003c]/20 rounded-sm text-[8px] font-mono px-1.5 font-bold">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                onClick={handleAddToBag}
                className="bg-[#24d9c7] hover:bg-[#24d9c7]/90 text-black font-black text-[10px] tracking-widest uppercase italic px-5 h-10 rounded-sm flex items-center gap-1.5 shadow-[0_0_15px_rgba(36,217,199,0.35)] transition-all cursor-pointer"
              >
